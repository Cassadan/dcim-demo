/*! UIkit 3.16.14 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ (function (
    ve,
    we
) {
    typeof exports == "object" && typeof module < "u"
        ...
        ? define("uikit", we)
        : ((ve = typeof globalThis < "u" ? globalThis : ve || self), (ve.UIkit = we()));
})(this, function () {
    "use strict";
    ...
    const Fo = /\B([A-Z])/g,
        ...
        Ho = /-(\w)/g,
        be = ft((t) =>
            (t.charAt(0).toLowerCase() + t.slice(1)).replace(Ho, (e, i) => i.toUpperCase())
        ),
    ...
    const Ke = { ratio: Hi, contain: As, cover: Lo };
    ...
    function p(t, e, i) {
        ...
        for (const n of I(t))
            it(i) && (i = i.call(n, p(n, e))), i === null ? xe(n, e) : n.setAttribute(e, i);
    }
    function $t(t, e) {
    ...
    function j(t) {
        return I(t).some((e) => e.offsetWidth || e.offsetHeight || e.getClientRects().length);
    }
    ...
    function Mt(t, e = !0, i = !1, s) {
        return O(t) && (t = new CustomEvent(t, { bubbles: e, cancelable: i, detail: s })), t;
    }
    function Ui(t) {
        return (
            (t[0] = Vi(t[0])),
    ...
    function h(t, e, i, s) {
        ...
        for (const o of n)
            if (O(e)) {
                if (((e = ti(e)), V(i))) return getComputedStyle(o).getPropertyValue(e);
                o.style.setProperty(e, bt(i) && !Zo[e] ? `${i}px` : i || ie(i) ? i : "", s);
            } else if (Z(e)) {
                const r = {};
                    ...
                    (n) =>
                        new Promise((o, r) => {
                            ...
                            R(
                                ...
                                y(n, "uk-transition"),
                                h(n, {
                                    transitionProperty: Object.keys(e).map(ti).join(","),
                ...
                (o) =>
                    new Promise((r, a) => {
                        ...
                        R(
                            ...
                            ot(e, Te) &&
                                (s && y(o, `uk-transform-origin-${s}`), n && y(o, `${Te}reverse`));
                    })
            )
        );
    }
    ...
    function ni(t, e) {
        for (e = H(ei(t, e)); e.firstChild; ) e = e.firstChild;
        return L(e, t), e;
    }
    function Ki(t, e) {
        return I(I(t).map((i) => (i.hasChildNodes() ? ni(Qt(i.childNodes), e) : L(i, e))));
    }
    function Ee(t) {
        I(t)
            .map(_)
    ...
    function zt(t) {
        ...
        return (
            nr.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : (i.textContent = t),
            Fs(i.childNodes)
        );
    }
    function Fs(t) {
    ...
    function P(t, e) {
        ...
        It(h(t, ["left", "top"]), (n, o) =>
            h(t, o, e[o] - i[o] + $(s === "absolute" && n === "auto" ? oi(t)[o] : n))
        );
    }
    function oi(t) {
    ...
    function he(t, e, i = "border-box") {
        return h(t, "boxSizing") === i
            ? Dt(Ft[e].map(Et), (s) => $(h(t, `padding${s}`)) + $(h(t, `border${s}Width`)))
            : 0;
    }
    function ri(t) {
    ...
    function Qi(t) {
        J.scheduled ||
            ((J.scheduled = !0),
            t && t < dr ? Promise.resolve().then(() => Zi(t)) : requestAnimationFrame(() => Zi(1)));
    }
    function Ws(t) {
        let e;
        for (; (e = t.shift()); )
    ...
    function fr([{ x: t, y: e }, { x: i, y: s }], [{ x: n, y: o }, { x: r, y: a }]) {
    ...
    function hi(t, e, i = { box: "border-box" }) {
        return pr
    ...
    function Vs(t) {
        if ((ui(t) && es(t, { func: "playVideo", method: "play" }), ci(t)))
            try {
                t.play().catch(k);
            } catch {}
    }
    function Ys(t) {
        ui(t) && es(t, { func: "pauseVideo", method: "pause" }), ci(t) && t.pause();
    }
    function Gs(t) {
        ui(t) && es(t, { func: "mute", method: "setVolume", value: 0 }), ci(t) && (t.muted = !0);
    }
    function Xs(t) {
        return ci(t) || ui(t);
    }
            ...
            e &&
                ...
                R(window, "message", o, !1, ({ data: r }) => {
                    try {
                        return (
                            (r = JSON.parse(r)),
                            (e && (r == null ? void 0 : r.id) === s && r.event === "onReady") ||
    ...
    function sn(t, e, i) {
        ...
        for (const [l, [c, , u, d]] of Object.entries(ct)) {
            ...
            if (r[l] === "flip") {
                ...
                if (!di(os(s, g, l), z, l)) {
                    if (di(s, z, l)) continue;
                    if (i.recursion) return !1;
                    const M = xr(t, e, i);
                    if (M && di(M, z, 1 - l)) return M;
                    continue;
                }
            } else if (r[l] === "shift") {
                const A = P(e[l]),
                    { offset: z } = i;
                g = Q(Q(s[u], f[u], f[d] - s[c]), A[u] - s[c] + z[l], A[d] - z[l]) - s[u];
            }
            a = os(a, g, l);
        }
        return a;
    ...
    function nn(t, e, i) {
        ...
        for (const [r, [a, , l, c]] of Object.entries(ct)) {
            ...
            o = os(
                o,
                u[l] - o[l] + on(s.target[r], c, u[a]) - on(s.element[r], c, o[a]) + +n[r],
                r
            );
        }
        return o;
    ...
    function wr(t, e, i, s, n) {
        ...
        return (
            i && ((o[ct[n][2]] += i), (o[ct[n][3]] -= i)), s && (o = an(o, P(Z(s) ? s[n] : s))), o
        );
    }
    function br(t, e, i, s) {
        const [n, o, r, a] = ct[s],
    ...
    function Ir(t, e) {
        for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
            ((t._initial && n) || (wt(e, i) && !Ge(e[i], t[i]))) && s.call(t, t[i], e[i]);
        t._initial = !1;
    }
    function Cr(t) {
        ...
        (t._hasComputed = !0),
            Object.defineProperty(t, e, {
                ...
                get() {
                    ...
                    return wt(s, e) || (s[e] = (i.get || i).call(t, n, o)), s[e];
                },
                set(s) {
                    const { _computed: n } = t;
    ...
    function Ar(t) {
        t._hasComputed &&
            (Tr(t, { read: () => Ir(t, dn(t)), events: ["resize", "computed"] }), Dr(), Oe.add(t));
    }
    function Or(t) {
    ...
    function Dr() {
        rs ||
            ...
            (rs = new MutationObserver(() => {
                for (const t of Oe) fi(t, "computed");
            })),
    ...
    function as(t, e, i) {
        ...
        if (((n = it(n) ? n.call(t, t) : n || t.$el), Z(n))) {
    ...
    function pn(t, e) {
        ...
        it(s) && !wt(t, l) && un(t, l, () => s.call(t, t)),
            (n = O(n) ? t[n] : n.bind(t)),
            it(o) && (o = o.call(t, t));
        const c = wt(t, l) ? t[l] : s,
            u = i(c, n, o, a);
        it(s) && Z(t[l]) && u.unobserve && cn(t, { handler: Fr(u), immediate: !1 }, l), fn(t, u);
    }
    function Fr(t) {
        return (e, i) => {
    ...
    (U.events =
        ...
        (U.update = function (t, e) {
            return Xe(ls(t, it(e) ? { read: e } : e), "order");
        }),
    ...
    function gn(t, e, i) {
        return U.computed(it(t) ? t.call(i, i) : t, it(e) ? e.call(i, i) : e);
    }
    function ls(t, e) {
        return (t = t && !Z(t) ? [t] : t), e ? (t ? t.concat(e) : Z(e) ? e : [e]) : t;
    }
    function Hr(t, e) {
        return V(e) ? t : e;
    }
    function De(t, e, i) {
        const s = {};
        if ((it(e) && (e = e.options), e.extends && (t = De(t, e.extends, i)), e.mixins))
            for (const o of e.mixins) t = De(t, o, i);
        for (const o in t) n(o);
        for (const o in e) wt(t, o) || n(o);
        function n(o) {
    ...
    function Lr(t) {
        return Z(t)
            ? t
            : O(t)
            ? t.split(/,(?![^(]*\))/).map((e) => (bt(e) ? St(e) : Mi(e.trim())))
            : [t];
    }
    function Wr(t) {
        ...
        const r = Object.keys(n),
            ...
            l = new MutationObserver((c) => {
                ...
                c.some(({ attributeName: d }) => {
                    ...
                    return (f === s ? r : [be(f), be(d)]).some((g) => !V(u[g]) && u[g] !== i[g]);
                }) && t.$reset();
            });
        l.observe(o, { attributes: !0, attributeFilter: a.concat(a.map((c) => `data-${c}`)) }),
            fn(t, l);
    }
    function fe(t, e) {
        var i;
    ...
    (ut.util = kr), (ut.options = {}), (ut.version = "3.16.14");
    const Gr = "uk-",
        qt = "__uikit__",
        pe = {};
    function wn(t, e) {
    ...
    function Kr(t) {
        (t.component = wn),
            ...
            (t.mixin = function (i, s) {
                (s = (O(s) ? this.component(s) : s) || this), (s.options = De(s.options, i));
            }),
            (t.extend = function (i) {
                i = i || {};
                const s = this,
            ...
            methods: {
                ...
                _toggle(t, e) {
                    ...
                    this.cls
                        ...
                        F("[autofocus]", t).some((s) => (j(s) ? s.focus() || !0 : s.blur())),
    ...
    async function na(t, e, { animation: i, duration: s, velocity: n, transition: o, _toggle: r }) {
        var a;
        ...
        f && (h(t, z, Jt - Ot + Ps), (No[z] = e ? Ps : Jt + Ps)),
            !f ^ (l === "reveal") && (h(Oi, z, -Jt + Ot), S.start(Oi, { [z]: e ? 0 : -Jt }, s, o));
        try {
            await S.start(t, No, s, o);
        } finally {
            h(t, Gh), Ee(Oi.firstChild), e || r(t, !1);
        }
    }
    function oa(t, e, i) {
        gt.cancel(t);
    ...
    function ze(t = {}) {
        return Ne({
            handler: function (e, i) {
                ...
                for (const o of I(it(s) ? s(this) : s))
                    F('[loading="lazy"]', o)
                        .slice(0, n - 1)
    ...
    function In(t) {
        return {
            observe(e, i) {
                return { observe: k, unobserve: k, disconnect: x(e, mt, i, { passive: !0 }) };
            },
            handler(e) {
                if (!Ct(e)) return;
                const i = le(e),
                    s = "tagName" in e.target ? e.target : _(e.target);
                R(document, `${_t} ${li} scroll`, (n) => {
                    const { x: o, y: r } = le(n);
    ...
    var Cn = {
        ...
        watch: {
            items(t, e) {
                ...
                const i =
                    (this.active !== !1 && t[Number(this.active)]) || (!this.collapsible && t[0]);
                i && this.toggle(i, !1);
            },
            toggles() {
                this.$emit();
    ...
    async function aa(t, e, { content: i, duration: s, velocity: n, transition: o }) {
        var r;
        (i = ((r = t._wrapper) == null ? void 0 : r.firstElementChild) || w(i, t)),
            t._wrapper || (t._wrapper = ni(i, "<div>"));
        const a = t._wrapper;
        h(a, "overflow", "hidden");
        const l = $(h(a, "height"));
        await S.cancel(a), vi(i, !1);
    ...
    var Tn = {
            ...
            connected() {
                (this.inView = this.autoplay === "inview"),
                    this.inView && !$t(this.$el, "preload") && (this.$el.preload = "none"),
                    G(this.$el, "iframe") &&
                        !$t(this.$el, "allow") &&
    ...
    var Pn = {
        ...
        data: { pos: `bottom-${X ? "right" : "left"}`, offset: !1, flip: !0, shift: !0, inset: !1 },
        connected() {
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const n = [this.flip && "flip", this.shift && "shift"],
                    o = {
                        element: [this.inset ? this.dir : ri(this.dir), this.align],
    ...
    function _n(t) {
        ...
        return (
            ...
            () => {
                (ds = !1), e(), h(i, { overflowY: "", touchAction: "", paddingRight: "" });
            }
        );
    }
    let K;
    var An = {
        ...
        observe: ze({ target: ({ toggle: t, $el: e }) => rt(t, e), targets: ({ $el: t }) => t }),
        events: [
            {
                name: "click",
                delegate() {
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (
                    ...
                    this.container && _(this.$el) !== this.container && L(this.container, this.$el),
            ...
            position() {
                N(this.$el, "uk-drop-stack"), h(this.$el, this._style), (this.$el.hidden = !0);
    ...
    function ma(t) {
        const e = () => t.$emit(),
            i = x(window, "resize", e),
            s = hi(jt(t.$el).concat(t.target), e);
        return () => {
            s.disconnect(), i();
        };
    }
    function va(t) {
        return x([document, ...jt(t.$el)], "scroll", () => t.$emit(), { passive: !0 });
    }
    function wa(t) {
    ...
    var On = {
        ...
        computed: {
            ...
            dropbar({ dropbar: t }) {
                return t
                    ? ((t =
                          this._dropbar || rt(t, this.$el) || w(`+ .${this.clsDropbar}`, this.$el)),
        ...
        events: [
            ...
            },
            {
                ...
                handler(t) {
                    ...
                    i === C.DOWN &&
                        ...
                        (t.preventDefault(),
                        !s || s.targetEl !== e
                            ? (e.click(), R(this.dropContainer, "show", ({ target: n }) => Bn(n)))
                            : Bn(s.$el)),
                        Dn(t, this.items, s);
                },
            },
                ...
                handler({ target: t }) {
                    this.isDropbarDrop(t) &&
                        (this.dropbar.previousElementSibling !== this.dropbarAnchor &&
                            ii(this.dropbarAnchor, this.dropbar),
            ...
            },
            {
                ...
                handler({ target: t }) {
                    ...
                    (this._observer = hi([e.$el, ...e.target], i)), i();
                },
            },
            {
                name: "beforehide",
    ...
    function Dn(t, e, i) {
        ...
        a === C.HOME
            ...
            ? (l = "next")
            : a === C.TAB &&
              ((s = i.targetEl) == null || s.focus(), (n = i.hide) == null || n.call(i, !1)),
            ~l &&
                (t.preventDefault(),
    ...
    var $a = {
            ...
            computed: {
                ...
                target({ target: t }, e) {
                    return (
                        t &&
                        ((t === !0 && _(this.input) === e && this.input.nextElementSibling) ||
                            w(t, e))
                    );
                },
            },
            update() {
                ...
                const n = Wi(e) ? "value" : "textContent",
                    ...
                    r =
                        (t = i.files) != null && t[0]
                            ? i.files[0].name
                            : T(i, "select") && (s = F("option", i).filter((a) => a.selected)[0])
                            ? s.textContent
                            : i.value;
                o !== r && (e[n] = r);
            },
        ...
        Mn = {
            ...
            observe: [
                Sn({ options: { childList: !0, attributes: !0, attributeFilter: ["style"] } }),
    ...
    function wi(t, e = !1) {
        ...
        return e && ([i, s] = Ht(t)), { top: i, left: s, bottom: i + n, right: s + o };
    }
    var ya = {
        extends: Mn,
        mixins: [st],
        ...
        observe: gi({ filter: ({ parallax: t }) => t }),
        update: [
            {
                write({ columns: t }) {
            ...
            },
            {
                read(t) {
                    ...
                    const n = E(this.$el),
                        ...
                        a = Math.max(...o) + r;
                    this.masonry && ((e = e.map((c) => Xe(c, "offsetTop"))), (s = ka(i, e)));
    ...
    var Ia = {
        ...
        update: {
            read() {
                return { rows: (this.row ? fs(this.elements) : [this.elements]).map(Ca) };
            },
            write({ rows: t }) {
    ...
    var Ea = {
        ...
        Fn = {
            ...
            disconnected() {
                this.svg.then((t) => {
                    this._connected ||
                        (Li(this.$el) && (this.$el.hidden = !1), at(t), (this.svgEl = null));
                }),
                    (this.svg = null);
            },
    ...
    const bi = {
        ...
        Za = {
            ...
            beforeConnect() {
                this.icon =
                    B(this.$el, "uk-search-icon") && oe(this.$el, ".uk-search-large").length
                        ? "search-large"
        ...
        ol = { extends: Gt, i18n: { label: "Previous page" }, data: { role: null } },
        $i = {};
    function rl(t) {
        t.icon.add = (e, i) => {
            const s = O(e) ? { [e]: i } : e;
    ...
    function al(t) {
        return bi[t]
            ? ($i[t] || ($i[t] = w((bi[ll(t)] || bi[t]).trim())), $i[t].cloneNode(!0))
            : null;
    }
    function ll(t) {
    ...
    var cl = {
        ...
        connected() {
            ...
            hl && xi(this.$el) && ((this.$el.loading = "lazy"), ms(this.$el)), gl(this.$el);
        },
        disconnected() {
        ...
        methods: {
            load() {
                ...
                const t = xi(this.$el) ? this.$el : dl(this.$el, this.dataSrc, this.sources);
    ...
    function ms(t, e) {
        ...
        } else e && !m(t.style.backgroundImage, e) && (h(t, "backgroundImage", `url(${qi(e)})`), v(t, Mt("load", !1)));
    }
    ...
    function gl(t) {
        xi(t) &&
            !$t(t, "src") &&
            p(t, "src", 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>');
    }
    function xi(t) {
        return G(t, "img");
    }
    ...
    var vs = {
        ...
        events: [
            ...
            },
            {
                ...
                handler(t) {
                    t.defaultPrevented ||
                        (t.preventDefault(), this.isToggled() === m(nt, this) && this.toggle());
                },
            },
            {
                name: "beforeshow",
                ...
                handler(t) {
                    ...
                    !this.stack && nt.length
                        ? (Promise.all(nt.map((e) => e.hide())).then(this.show), t.preventDefault())
                        : nt.push(this);
                },
            },
            {
    ...
    var Sl = { extends: Cn, data: { targets: "> .uk-parent", toggle: "> a", content: "> ul" } },
        Il = {
            extends: On,
            data: {
                ...
                },
                {
                    ...
                    handler() {
                        this.mode === "reveal" &&
                            ...
                            (ni(this.panel, "<div>"), y(_(this.panel), this.clsMode));
    ...
    function jn() {
        return (
            w('meta[name="viewport"]', document.head) || L(document.head, '<meta name="viewport">')
        );
    }
    var Pl = {
            mixins: [st],
        ...
        _l = {
            ...
            update: {
                ...
                write(t) {
                    et(this.$el, Ke.contain({ height: this.height, width: this.width }, t).height);
                },
                events: ["resize"],
            },
        },
            ...
            observe: Ne({
                ...
                handler(t) {
                    ...
                    for (const { target: i, isIntersecting: s } of t) {
                        e.has(i) || e.set(i, { cls: tt(i, "uk-scrollspy-class") || this.cls });
                        const n = e.get(i);
            ...
            update: [
                {
                    read({ height: t, width: e, margin: i, sticky: s }, n) {
                        if (((this.inactive = !this.matchMedia || !j(this.$el)), this.inactive))
                            return;
                    ...
                    write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
                        if (((this.inactive || n || !this.isFixed) && Vn(this.$el), this.inactive))
                            return;
            ...
            methods: {
                ...
                hide() {
                    ...
                    this.setActive(!1),
                        ...
                        e
                            ? h(this.$el, "top", t)
                            : h(this.$el, { position: "", top: "", width: "", marginTop: "" }),
    ...
    function ws(t, e, i, s) {
        if (!t) return 0;
        if (bt(t) || (O(t) && t.match(/^-?\d/))) return i + lt(t, "height", e, !0);
        {
    ...
    function Yn(t) {
        h(t, "transition", "0s"), requestAnimationFrame(() => h(t, "transition", ""));
    }
    function Gn(t) {
        return Math.ceil(
            Math.max(
    ...
    var zl = {
        ...
        methods: {
            async getSvg() {
                return G(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy"
                    ? new Promise((t) => R(this.$el, "load", () => t(this.getSvg())))
                    : Hl(await Fl(this.src), this.icon) || Promise.reject("SVG not found.");
            },
        },
    };
    function Xn(t) {
    ...
    var Kn = {
            ...
            watch: {
                ...
                connectChildren() {
                    const t = this.index();
                    for (const e of this.connects) E(e).forEach((i, s) => q(i, this.cls, s === t));
                    this.$emit();
                },
                toggles(t) {
                    this.$emit();
            ...
            update() {
                var t;
                p(this.connects, "role", "presentation"), p(E(this.$el), "role", "presentation");
    ...
    var Yl = {
        ...
        methods: {
            ...
            stop() {
                this.timer &&
                    (clearInterval(this.timer), v(this.$el, "countdownstop"), (this.timer = null));
            },
            update() {
                const t = Gl(this.date);
                t.total ||
                    (this.stop(), this.end || (v(this.$el, "countdownend"), (this.end = !0)));
                for (const e of Vl) {
    ...
    function Zn(t, e, i, s = 0) {
        const n = ki(e, !0),
            ...
            c = a(async () => {
                ...
                u !== f && A.push(S.start(e, { height: f }, i / 2 + g.length * s, "ease")),
        ...
        return B(e, $s) ? Qn(e).then(c) : B(e, xs) ? Qn(e).then(l).then(c) : l().then(c);
    }
    function ki(t, e) {
        return e && (t.dataset.transition = 1 + ki(t)), St(t.dataset.transition) || 0;
    }
    function Qn(t) {
        return Promise.all(
            E(t)
                .filter(S.inProgress)
                .map((e) => new Promise((i) => R(e, "transitionend transitioncanceled", i)))
        );
    }
    function to(t) {
    ...
    async function Kl(t, e, i) {
        ...
        s.forEach((f, g) => c[g] && h(f, c[g])), h(e, o), v(e, "scroll"), J.flush(), await so();
        const d = s
        ...
        try {
            await Promise.all(d),
                s.forEach((f, g) => {
                    p(f, u[g]), _(f) === e && h(f, "display", l[g].opacity === 0 ? "none" : "");
                }),
                p(e, "style", r);
        } catch {
            p(s, "style", ""), Ql(e, o);
    ...
    var no = {
        ...
        th = {
            ...
            events: {
                ...
                handler(t) {
                    (t.type === "keydown" && t.keyCode !== C.SPACE) ||
                        (Y(t.target, "a,button") && (t.preventDefault(), this.apply(t.current)));
                },
            },
            methods: {
                apply(t) {
    ...
    function oh(t, e, i) {
        return [...t].sort(
            (s, n) =>
                tt(s, e).localeCompare(tt(n, e), void 0, { numeric: !0 }) * (i === "asc" || -1)
        );
    }
    function rh(t) {
        ...
        return {
            ...
            show(u, d = 0, f) {
                ...
                return (
                    ...
                    this.translate(d),
                    Si(e, "itemin", { percent: d, duration: u, timing: g, dir: i }),
                    Si(t, "itemout", { percent: 1 - d, duration: u, timing: g, dir: i }),
            ...
            translate(u) {
                ...
                h(e, d[1]),
                    h(t, d[0]),
                    Si(e, "itemtranslatein", { percent: u, dir: i }),
                    Si(t, "itemtranslateout", { percent: 1 - u, dir: i });
            },
            percent() {
                return o(t || e, e, i);
            },
        ...
        methods: {
            ...
            move(t) {
                ...
                [this.index, this.prevIndex]
                    .filter((f) => !m([o, s], f))
                    .forEach((f) => {
                        v(i[f], "itemhidden", [this]), u && ((d = !0), (this.prevIndex = s));
                    }),
                ...
                if (
                    (Bt(document, Ss, this.move, ks), Bt(document, ho, this.end, lo), this.dragging)
                )
                    if (((this.dragging = null), this.index === this.prevIndex))
                        ...
                        const t =
                            (X ? this.dir * (X ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos;
        ...
        co = {
            ...
            methods: {
                ...
                getIndex(t = this.index, e = this.index) {
                    return Q(dt(t, this.slides, e, this.finite), 0, Math.max(0, this.maxIndex));
                },
    ...
    var fo = {
        ...
        po = {
            ...
            events: [
                { name: `${ai} ${mt} keydown`, handler: "showControls" },
                {
                    name: "click",
                    self: !0,
                    delegate() {
                ...
                },
                {
                    ...
                    self: !0,
                    handler() {
                        this.hideControls(), N(this.slides, this.clsActive), S.stop(this.slides);
                    },
                },
                {
                    name: "hidden",
    ...
    var mh = {
        ...
        async connected() {
            ...
            await S.start(h(this.$el, this.startProps), { opacity: 1, [this.marginProp]: t }),
    ...
    var vo = {
        ...
        computed: {
            props(t, e) {
                const i = {};
                for (const n in t) n in Ii && !V(t[n]) && (i[n] = t[n].slice());
                const s = {};
    ...
    function Ci(t, e, i) {
        let s = Ei(i) || { x: "px", y: "px", rotate: "deg" }[t] || "",
            n;
        return (
            t === "x" || t === "y"
                ? ((t = `translate${Et(t)}`), (n = (o) => $($(o).toFixed(s === "px" ? 0 : 6))))
                : t === "scale" &&
                  ((s = ""), (n = (o) => (Ei([o]) ? lt(o, "width", e, !0) / e.offsetWidth : o))),
    ...
    function Is(t, e, i) {
        return (
            ...
            (s, n) => {
                const [o, r, a] = xo(i, n),
                    l = o
                        .map((c, u) => ((c += a * (r[u] - c)), u === 3 ? $(c) : parseInt(c, 10)))
                        .join(",");
                s[t] = `rgba(${l})`;
            }
        );
    ...
    function wh(t, e) {
        return je(t, "color", e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map($);
    }
    function Xt(t, e, i) {
        i.length === 1 && i.unshift(0);
        const s = Ei(i) || { blur: "px", hue: "deg" }[t] || "%";
        return (
    ...
    function xh(t, e, i, s) {
        ...
        for (const u of r) {
            const d = s[u].map(([M]) => M),
                ...
                z = g - f;
            (a[u] = `${(A ? -z : 0) - (A ? f : g)}px`), (o[u === "bgy" ? "height" : "width"] += z);
        }
            ...
            if (
                ...
                o === 0
                    ? a === null
                        ? (a = 0)
                        : a && i.push([r, 0])
                    : o === s - 1 && (a === null ? (a = 1) : a !== 1 && (i.push([r, a]), (a = 1))),
                i.push([r, a]),
                a === null)
            )
                n++;
    ...
    var Sh = {
        ...
        computed: {
            ...
            start({ start: t }) {
                ...
                return lt(t || ((e = (1 - e) * 100) && `${e}vh+${e}%`), "height", this.target, !0);
            },
        },
        observe: [pt({ target: ({ $el: t, target: e }) => [t, e] }), gi()],
        update: {
            read({ percent: t }, e) {
    ...
    var So = {
        ...
        Io = {
            observe: ze({ target: ({ slides: t }) => t, targets: (t) => t.getAdjacentSlides() }),
        };
        ...
        return {
            ...
            show(c, u = 0, d) {
                ...
                return (
                    ...
                    this.translate(u),
                    (u = t ? u : Q(u, 0, 1)),
                    Ts(this.getItemIn(), "itemin", { percent: u, duration: c, timing: f, dir: i }),
                    t &&
                    ...
                    S.start(o, { transform: W(-l * (X ? -1 : 1), "px") }, c, f).then(r.resolve, k),
                    r.promise
                );
            },
            cancel() {
            ...
            translate(c) {
                ...
                h(o, "transform", W(Q(-l + (u - u * c), -Pi(o), b(o).width) * (X ? -1 : 1), "px"));
            ...
            percent() {
                return Math.abs((h(o, "transform").split(",")[4] * (X ? -1 : 1) + a) / (l - a));
            },
            getDistance() {
                return Math.abs(l - a);
            },
    ...
    function _i(t, e) {
        return (t && (oi(t).left + (X ? b(t).width - b(e).width : 0)) * (X ? -1 : 1)) || 0;
    }
    function To(t, e) {
        e -= 1;
        const i = b(t).width,
    ...
    var Eh = {
        ...
        update: {
            write() {
                for (const t of this.navItems) {
                    ...
                    e !== !1 &&
                        (t.hidden =
                            !this.maxIndex || e > this.maxIndex || (this.sets && !m(this.sets, e)));
                }
                this.length &&
                    !this.dragging &&
                    !this.stack.length &&
        ...
        events: {
            beforeitemshow(t) {
                ...
                (this.duration =
                    uo(this.avgWidth / this.velocity) * (b(this.slides[i]).width / this.avgWidth)),
                    this.reorder();
            },
            itemshow() {
        ...
        methods: {
            ...
            updateActiveClasses() {
                ...
                for (const i of this.slides) {
                    ...
                    for (const n of F(ke, i))
                        wt(n, "_tabindex") || (n._tabindex = p(n, "tabindex")),
    ...
    function Ph(t, e) {
        ...
        const { width: i } = b(t);
        if (!e) return Math.ceil(Pi(t)) < Math.trunc(i + _h(t));
        const s = E(t),
            n = Math.trunc(i / 2);
        for (const o in s) {
            const r = s[o],
    ...
    var Ah = {
            ...
            scale: {
                show() {
                    return [{ opacity: 0, transform: ge(1 + 0.5), zIndex: 0 }, { zIndex: -1 }];
                },
                percent(t) {
                    return 1 - h(t, "opacity");
                },
        ...
        Dh = {
            ...
            methods: {
                ...
                start(t) {
                    ...
                    yt(this.origin, { offsetLeft: this.pos.x - e, offsetTop: this.pos.y - i }),
                ...
                move(t) {
                    ...
                    if ((Bt(document, ai, this.move), Bt(document, _t, this.end), !this.drag))
                        return;
                    Mh();
                ...
                insert(t, e) {
                    y(this.items, this.clsItem);
                    const i = () => (e ? ei(e, t) : L(this.target, t));
                    this.animate(i);
                },
                remove(t) {
    ...
    function Fh(t, e, i, s, n, o) {
        ...
        if (!o) return Hh(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
    ...
    var Lh = {
        ...
        disconnected() {
            this.hide(),
                p(this.$el, "title") || p(this.$el, "title", this._hasTitle ? this.title : null);
        },
        methods: {
            show() {
    ...
    function Rh(t, e, [i, s]) {
        ...
        return (
            n[a[0]] === o[a[0]] ? (s = a[0]) : n[a[1]] === o[a[1]] ? (s = a[1]) : (s = "center"),
            [i, s]
        );
    }
    var jh = {
        ...
        events: {
            ...
            drop(t) {
                ...
                e != null && e.files && (N(this.$el, this.clsDragover), this.upload(e.files));
            },
            dragenter(t) {
                Ai(t);
            },
            ...
            dragleave(t) {
                Ai(t), N(this.$el, this.clsDragover);
            },
        },
        methods: {
            async upload(t) {
